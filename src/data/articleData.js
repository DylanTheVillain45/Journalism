...
import bondingDayImage from "../assets/Ultimate.jpg";
import collegeDroupout from "../assets/TheCollegeDroupout.jpg";
import mrHalsted from "../assets/mrHallsted.jpg";
import DoeBanner from "../assets/DoeBanner.png";
import TransformersOne from "../assets/TransformersOne.jpg";
...
`,
  ...
  },
  {
    ...
    text: `
In the past few years, the film landscape has changed in a major way. Just a few years ago, it was a guarantee that any film in a popular franchise would make its budget back and then some. But now, ever since the pandemic, there is no certainty in what films will make money and what will be a box office disappointment. And it’s sad that even when big franchise films are surprisingly great, like Sony’s Spider-Verse series, there isn’t a guarantee that they’ll be successful, and we’ve seen that recently with Josh Cooley’s Transformers One. This is very unfortunate, because unlike many other franchise films being released, Transformers One is definitely a film that deserves to be a big hit.
To be honest, my expectations were never super high for this film. The marketing made it seem like it would be aimed primarily towards little kids, with the humor appearing to be a bit overbearing in the film’s trailers. But when I went to see this film, my mind was kind of blown. This film is not only funny, but is filled with heart, passion, and a far more mature story than the trailers made it seem.
Transformers One follows Orion Pax and D-16, two robot friends working as miners on the futuristic Planet Cybertron, who would go on to be sworn enemies, Optimus Prime and Megatron. Soon, the two attempt to find and retrieve the Matrix of Leadership, a powerful device that could potentially restore peace across all of Cybertron. However, as they proceed on their mission, Orion and D-16 begin to form new ideologies, and begin to drift further apart as they both attempt to stop a threat against their planet.
Like I said, this film REALLY surprised me. I was initially turned off by the voice actors picked for the film. Chris Hemsworth as Orion Pax seemed like another “Chris Pratt as Mario” situation waiting to happen. But he was surprisingly excellent. At no point did I hear a celebrity phoning it in, I just believed that I was watching the character that Hemsworth was voicing. That goes for nearly every other voice actor as well, especially Hemsworth and Brian Tyree Henry, who voiced D-16.
If I had any faults with this film, I would say that some moments with B-127 (played by Keegan-Michael Key) felt a bit out of place in terms of where they were placed in the film. Also, while I found the film to be very well-paced, I’d prefer it if there were at least 10 to 15 extra minutes spent with Orion and D-16 before the plot begins moving forward. What we get works well, but it may have benefited from even more time to fully sell us on their friendship.
Other than those minor complaints, Transformers One is a surprising home-run for the franchise, and is worthy of your money and time. Please make sure to see it while it’s still in theaters. It is one of my favorite films of the year so far, and I’d highly recommend it. Transformers One gets an 8/10.
